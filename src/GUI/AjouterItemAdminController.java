...
public class AjouterItemAdminController implements Initializable {
    ...
    private void ajouter(ActionEvent event) throws IOException {
        ...
        if (textfield_libelle.getText().equals("") || textfield_libelle.getText().equals("Insérer libellé") || textarea_description.getText().equals("") || textarea_description.getText().equals("Insérer description") || cbs == null) {
            ...
            Item i = new Item(textfield_libelle.getText(), textarea_description.getText(), type, etat, imageview_imageurl.getImage().impl_getUrl(), CurrentUser.getInstance().getId(), id_cat,0,0,0);
            sp.ajouter(i);
