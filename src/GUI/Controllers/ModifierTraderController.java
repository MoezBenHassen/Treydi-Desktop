...
public class ModifierTraderController implements Initializable {
    ...
    private void modifier(ActionEvent event) throws IOException {
        ...
        if (found == false) {
            ...
            if (tfnom.getText().equals("Insérer nom") || tfprenom.getText().equals("Insérer prenom") || tfadresse.getText().equals("Insérer adresse") || tfemail.getText().equals("Insérer email") || tfpassword.getText().equals("Insérer password")) {
                ...
                Utilisateur trader = new Trader(tfpassword.getText(), tfnom.getText(), tfprenom.getText(),  tfemail.getText(), tfadresse.getText() ,  selectedUser.getAvatar_url(),selectedUser.getRole(),selectedUser.getScore(),selectedUser.getDate_naissance(),Integer.parseInt(textfield_id.getText()), selectedUser.getArchived());
                us.modifier(trader);
