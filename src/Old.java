...
public class Old {
    public static void main(String[] args) {
        ...
        Item i1 =new Item("Nintendo Switch", "Nintendos latest console released in 2017, the worlds first portable home console", Item.type.Physique,Item.state.Neuf,"null",4,1,0);
        Item i2 =new Item("Playstation 5", "Sonys latest console released in 2020", Item.type.Physique,Item.state.Occasion,"null",4,1,0);
        ...
        Item ii2 =new Item(2,"Playstation 5", "Sonys latest console released in 2020, the worlds most powerful console", Item.type.Physique,Item.state.Neuf,"null",2,1,0);
